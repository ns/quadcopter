...
void Accel::calibrate(){
  // load from eeprom
  zero[XAXIS] = 0;//eeprom_read_int(EEPROM_ADDR_ACCEL_PITCH);
  zero[YAXIS] = 0;//eeprom_read_int(EEPROM_ADDR_ACCEL_ROLL);
  zero[ZAXIS] = 0;//eeprom_read_int(EEPROM_ADDR_ACCEL_YAW);
